...
**Bean Piss Resort** is a browser-based time management game where you run your own bean piss resort. Serve customers, earn money, upgrade your facilities, and climb the leaderboard to become the ultimate bean piss tycoon!

### Game Highlights

- 🏨 Manage a bean resort with 4 different service stations
...
- **4 Service Stations**
  - 🥤 Bean Extraction Station - $6 per service
  - 🥠 Dessert Station - $5 per service
  - 🏦 ATM Station - $10 per service
  - 🎒 Study Service Station - $15 per service
...
|---------|--------|-----------|
| 🍶 Limited Edition Cups | +10% patience per level + $5/min passive income | 3 |
| 🍡 International Desserts | +15% patience per level + $8/min passive income | 3 |
| 🛜 Wifi Station | +12% patience per level + $6/min passive income | 3 |
| 🪪 Customer Loyalty | +$5 tip bonus per level + $15/min passive income | 3 |
...
1. **Download the game files**
   ...
   git clone https://github.com/Unkn5wn/Bean-Resort.git
...
2. **Click "Start Game"** - Begin your bean resort journey
...
- Each customer shows:
  - Name (e.g., "Sophia")
  - Desired service (🥤 Bean Extraction)
  - Patience meter (😊 100%)
...
|---------|----------|------------|
| 🥤 Bean Extraction | 5 seconds | $50 |
| 🥠 Desserts  | 6 seconds | $60 |
| 🏦 ATM  | 7 seconds | $80 |
| 🎒 Study Service | 8 seconds | $100 |
...
- **Tip Bonus** (from Loyalty upgrade)
  - +$5 per Loyalty level
...
```javascript
const services = [
    { name: 'Bean Extraction', icon: '🥤', duration: 5000, price: 6 },
...
1. Start with **Limited Edition Cups** (best patience boost)
...
1. Max out Customer Loyalty early for tip bonuses
2. Time customer spawns to avoid overcrowding
3. Focus on high-value services (Study Services)
